...
LOCAL_DIR = Path("/root/autodl-tmp/research/VLABench/VLABench/assets")
MANIFEST = Path("/root/autodl-tmp/research/Embodied_Delta_Debugging/vlabench_assets_manifest.txt")
FAILED_LIST = Path("/root/autodl-tmp/research/Embodied_Delta_Debugging/vlabench_assets_failed.txt")
